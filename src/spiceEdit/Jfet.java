...
public class Jfet
{
	 ...
	 */
	public String BETATCE;

	/**
	 * Zero-bias GD junction capacitance
	 */
	public String CGD;

	/**
	 * Zero-bias GS junction capacitance
	 */
	public String CGS;

	/**
	 * Coefficient for forward-depletion capacitance
	 */
	public String FC;
